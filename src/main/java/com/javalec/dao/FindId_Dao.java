...
public class FindId_Dao {
	...
	public int checkInfo(String name, String date, String email) {
		...
		try {
			...
			// 쿼리 작성
			String query = "select count(mregdate) as count " + "from member "
					+ "where mname = '" + name + "' " + "and mbirth = '" + date + "' " + "and memail = '" + email + "'";
	...
	public String findId(String name, String date, String email) {
		...
		try {
			...
			connection = dataSource.getConnection();
			// 쿼리 작성
			String query = "select mid " + "from member " + "where mname = '" + name + "' " + "and mbirth = '" + date
					+ "' " + "and memail = '" + email + "'";
