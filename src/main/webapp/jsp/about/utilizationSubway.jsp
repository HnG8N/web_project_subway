			...
			<div class="utilization_subway_content" id="store_order" style="display:block;">
				<div class="slider_wrapper">
					...
					<div class="img_content">
						<ol>
							<!-- 20180202 -->
							<li class="active"><div class="img"><img alt="메뉴 선택" src="../images/utilization/img_store_order01.png" /></div></li>
							<li><div class="img"><img alt="빵 선택 " src="../images/utilization/img_store_order02.png" /></div></li>
							<li><div class="img"><img alt="토핑 추가" src="../images/utilization/img_store_order03.png" /></div></li>
							<li><div class="img"><img alt="야채&소스 선택" src="../images/utilization/img_store_order04.png" /></div></li>
							<li><div class="img"><img alt="세트 선택" src="../images/utilization/img_store_order05.png" /></div></li>
							<!--// 20180202 -->
						</ol>
					</div>
					<div class="info_content">
						...
						<ol>
							<li class="active" style="margin-top:0; opacity:1">
								<strong>메뉴 선택</strong>
								<p class="txt1">메뉴를 고르세요.<br />샌드위치(15cm 또는 30cm)와<br />샐러드 중 선택 가능합니다.</p>
								<div class="btns_wrapper">
                                    <a class="btn bgc_bw size1" href="/menuList/sandwich" style="width:142px;" target="_blank">
                                        <span>샌드위치 메뉴</span><i class="i_mag">&nbsp;</i>
                                    </a>
									<!-- 18.02.01 텍스트 및 아이콘 수정 -->
                                    <a class="btn bgc_bw size1" href="/menuList/salad" style="width:142px;" target="_blank">
                                        <span>샐러드 메뉴</span><i class="i_mag">&nbsp;</i>
                                    </a>
									<!-- 18.02.01 텍스트 및 아이콘 수정 -->
								</div>
							</li>
							<li>
								<strong>빵 선택 <span>(샐러드 선택 시 제외)</span></strong>
								<p class="txt1">매장에서 직접 구운 6가지 종류 중<br />고객님이 원하는 빵으로<br />추가비용 없이 선택 가능합니다.</p>
								<div class="btns_wrapper">
									<a class="btn bgc_bw size1" href="/freshInfo?tab=bread" style="width:105px;" target="_blank"><span>빵 종류</span><i class="i_mag">&nbsp;</i></a><!-- 18.02.01 텍스트 및 아이콘 수정 -->
								</div>
							</li>
							<li>
								...
								<div class="btns_wrapper">
									<a class="btn bgc_bw size1" href="/menuList/sandwich?tab=ITEM_SANDWICH.TOPPING" style="width:142px;" target="_blank"><span>추가토핑 메뉴</span><i class="i_mag">&nbsp;</i></a><!-- 18.02.01 아이콘 수정 -->
								</div>
							</li>
							<li>
								...
								<div class="btns_wrapper">
									<a class="btn bgc_bw size1" href="/freshInfo?tab=vegetable" style="width:122px;" target="_blank"><span>야채 종류</span><i class="i_mag">&nbsp;</i></a><!-- 18.02.01 아이콘 수정 -->
									<a class="btn bgc_bw size1" href="/freshInfo?tab=sauce" style="width:122px;" target="_blank"><span>소스 종류</span><i class="i_mag">&nbsp;</i></a><!-- 18.02.01 아이콘 수정 -->
								</div>
							</li>
							<li>
								<strong>세트 선택</strong>
							...
							<div class="content">
								...
								<ul>
									<li>
										...
										<em>SALAD</em>
										<p>로스트치킨은 샐러드로 드셔도 좋습니다.<br />관리의 시작은 써브웨이로부터!</p>
									</li>
									<li>
									...
									<li class="bul02">
										...
										<em>TOPPING</em>
										<p>올리브, 피클, 할라피뇨를 빼고 드시면,<br />
											담백하고 부드러운 로스트 치킨을<br />
											제대로 즐길 수 있습니다.
										</p>
									</li>
								</ul>
