...
<body>
	<form action="login.do" method="post" name="loginForm">
		...
		<div class="bg_type01" id="container">
			<input id="returnUrl" name="returnUrl" type="hidden" value="/" /> <input
				id="dormantCloseYn" name="dormantCloseYn" type="hidden" value="N" />
				...
				<div class="signin_wrapper">
					...
					<div class="signin_input">
						<div class="form_box">
									...
									<dl>
										...
										<dd>
											<span class="form_text"> <input class="required-value"
												id="id" name="id" placeholder="아이디 입력" type="text" value="" />
											</span>
										</dd>
										<dt>비밀번호</dt>
										<dd>
							...
							<label class="form_checkbox"> <input id="rememberId"
								name="rememberId" type="checkbox" /> <span class="icon"></span>아이디
								저장
							</label>
						</div>
					</div>
					<div class="signin_btn">
						<a class="btn bgc_point on" href="javascript:void(0);" id="login" style="width: 370px;"><span>로그인</span></a> 
							<a href="/member/dormant/noti" id="popDormantNoti"> </a>
							<a href="/member/dormant/closing" id="popDormantClosing"> </a>
							<a href="/member/agr/status/noti" id="popMemberAgrNoti"> </a>
					</div>
